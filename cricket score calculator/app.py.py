...
#     team_1b="TEAM_A"
#     team_1f="TEAM_B"
#     innings(no_o_over, team_1b, team_1f)

#     # second innings
#     team_2b=team_1f
#     team_2f=team_1b
#     innings(no_o_over, team_2b, team_2f)
...
# def t_20_match():
#     t20_overs=20
#     print("match started : total overs =20")
#     for over_t in range(t20_overs):
#         an_over()
#         print(f"{over_t+1} overs completed ")
